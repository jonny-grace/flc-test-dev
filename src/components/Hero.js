...
const Hero = ({hero}) => {
  ...
  return (
    ...
    >
      ...
      <Image src={hero.path} width={1000} alt='' height={1000} className=' w-full h-[300px] md:h-[450px] xxl:h-[937.09px] xl:h-[700px] lg:h-[660px] ' />
      ...
      >
        <div className=" w-64  text-center lg:w-[444px] xl:w-[544px] xxl:w-[544px]  text-white">
          <h1 className="text-5xl lg:text-6xl  xxl:font-semibold xl:text-[90px] font-inter font-gotham font-bold">
