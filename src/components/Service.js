    ...
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-16 lg:py-14 mx-auto font-inter mb-5">
      ...
      {services && services.map((service, index) => {
          return (
            ...
            <a  className="group flex flex-col justify-center   items-center md:justify-start md:items-start     p-4 md:p-7 dark:hover:bg-slate-800" href="/services">
              <div className={`  ${index==2 || index==3 ?'pt-5':null} `}><div className="flex  w-28 h-full   ">
                <img
              ...
              <div className="mt-7  ">
                <h3 className="text-lg font-semibold " style={{ color: getColorByIndex(index) }}  >{service.attributes.name}</h3>
                <p className="mt-3 text-gray-800">{service.attributes.description.slice(1, 120)}
                </p>
