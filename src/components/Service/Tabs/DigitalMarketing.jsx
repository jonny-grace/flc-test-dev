...
const DigitalMarketing = ({digitalMarketing}) => {
  ...
  const subServices=digitalMarketing && digitalMarketing.attributes.sub_services.data.map((sub)=>{
    return sub
  })
  return (
    <div className="mt-16  font-inter">
      <div className="grid grid-cols-1 md:grid-cols-2 justify-items-center gap-8">
        <div className="grid h-min max-w-lg">
          ...
          <h5 className="text-black text-5xl py-8 font-bold">{digitalMarketing?.attributes?.name} </h5>
