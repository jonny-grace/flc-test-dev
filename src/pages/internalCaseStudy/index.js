    ...
    return (
        ...
        <div className=' w-full overflow-x-hidde mb-16'><Navbar />
            <div
                ...
                <div
                    className="relative mx-auto max-w-screen-xl px-4 py-48 sm:px-6 lg:flex lg:justify-center mb-[900px]  lg:items-center lg:px-3"
                >
           ...
           <div className=' mx-32'><Carousel /></div> 
